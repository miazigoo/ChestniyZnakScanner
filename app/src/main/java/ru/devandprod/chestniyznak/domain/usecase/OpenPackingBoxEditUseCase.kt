...
class OpenPackingBoxEditUseCase @Inject constructor(
    private val repository: PackingRepository,
) {
    suspend operator fun invoke(boxId: Long, reason: String = "tablet"): PackingBoxActionResult =
        repository.openBoxEdit(boxId, reason)
}
