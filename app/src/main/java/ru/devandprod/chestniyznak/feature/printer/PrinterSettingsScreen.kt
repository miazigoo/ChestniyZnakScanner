    ...
    Surface(
        ...
        Box(
            ...
            Column(
                ...
                Text(
                    text = "Для этого ТСД доступно принтеров: $printerCount. Выбранное устройство будет использоваться при закрытии и повторной печати.",
    ...
    Surface(
        ...
        Column(
            ...
            Row(
                ...
                PrinterMetaChip("ТСД", state.deviceId)
